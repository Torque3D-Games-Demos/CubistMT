...
moveMap.bindCmd(keyboard, "0", "setMosaicClient(0);", "");
moveMap.bindCmd(keyboard, "1", "setMosaicClient(1);", "");
moveMap.bindCmd(keyboard, "2", "setMosaicClient(2);", "");
moveMap.bindCmd(keyboard, "3", "setMosaicClient(3);", "");
moveMap.bindCmd(keyboard, "9", "setMosaicClient(9);", "");
