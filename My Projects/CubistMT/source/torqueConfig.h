...
#define TORQUE_APP_NAME            "CubistMT"
...
//added by PG. If defined, web page data is ghosted
//#define  WEB_GHOSTING   
...
#define TORQUE_FRAME_SIZE     64 << 20
//#define TORQUE_FRAME_SIZE     256 << 20
...
//sort meshes by depth relative to camera. added to make web pages sort properly
#define  TORQUE_SORT_BY_CAMERA_DEPTH

#ifdef TORQUE_DEBUG

  // #define TORQUE_GATHER_METRICS 0
   #define TORQUE_GATHER_METRICS 1
